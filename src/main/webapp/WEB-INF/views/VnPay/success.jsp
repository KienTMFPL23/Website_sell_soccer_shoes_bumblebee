    ...
    <div class="container">
        <div class="w-50 m-auto">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td>Tổng tiền:</td>
                    <td><span><fmt:formatNumber>${totalPrice / 100}</fmt:formatNumber></span></td>
                </tr>
                <tr>
                    <td>Thời gian thanh toán:</td>
                    <td><span><fmt:formatDate value="${paymentTime}" pattern="dd/MM/yyy HH:mm:ss"></fmt:formatDate> </span></td>
                </tr>

                </tbody>
            </table>
            <a href="/bumblebee/home" class="btn btn-primary">Về trang chủ</a>
            <a href="/bumblebee/don-mua" class="btn btn-primary">Xem đơn hàng vừa đặt</a>
        </div>
    </div>
</div>
<!-- end body -->
