        ...
        <div class="col-lg-4">
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <!-- Them Khach hang -->
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#khachHang">
                            <img src="/images_template/add.png">
                        </button>
                        ...
                        <div class="modal fade" id="khachHang" tabindex="-1" aria-labelledby="themKhachHang"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form:form method="post" modelAttribute="khachHang" action="/bumblebee/ban-hang-tai-quay/them-khach-hang">
                                            <div class="mb-3">
