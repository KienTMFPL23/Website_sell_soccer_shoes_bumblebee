...
<div class="container">
    ...
    <div class="header">
        ...
        <form:form modelAttribute="searchForm">
            <div class="search" >
                ...
                <form:input path="keyword" cssClass="inputSearch" placeholder="bạn đang tìm kiếm sản phẩm..."></form:input>
            </div>
        </form:form>
    ...
    <div class="text-center">
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item"><a class="page-link" href="/admin/loai-giay?p=${page.number-1}&keyword=${param.keyword}">Previous</a></li>
                <li class="page-item"><a class="page-link" href="/admin/loai-giay?p=0&keyword=${param.keyword}">1</a></li>
                <li class="page-item"><a class="page-link" href="/admin/loai-giay?p=1&keyword=${param.keyword}">2</a></li>
                <li class="page-item"><a class="page-link" href="/admin/loai-giay?p=2&keyword=${param.keyword}">3</a></li>
                <li class="page-item"><a class="page-link" href="/admin/loai-giay?p=${page.number+1}&keyword=${param.keyword}">Next</a></li>
            </ul>
        </nav>
    </div>
</div>