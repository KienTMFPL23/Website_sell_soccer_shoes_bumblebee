                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="container" style="margin-top: 70px">
                                                                ...
                                                                <p>+ Khi đổi, trả hàng cần còn nguyên tem, không được làm hỏng hoặc bẩn sản phẩm khi đổi, trả. Cần quay video làm bằng chứng nếu không
                                                                    cửa hàng sẽ không chấp nhận đổi trả</p>
                                                                <div>
                                                                    <strong style="font-size: 20px">III. Hướng dẫn đổi - trả hàng</strong>
                                                                    ...
                                                                    <strong style="font-size: 15px">Nếu có thắc mắc vui liên hệ đến số điện thoại: 0349708826</strong>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
